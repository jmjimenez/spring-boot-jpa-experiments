...
public class SwaggerConfig {
    ...
    public OpenAPI customOpenAPI() {
        return new OpenAPI().info(new Info().title("Spring Boot JPA Experiments API").description(
                "API documentation for Spring Boot JPA experiments project using hexagonal architecture")
                .version("1.0.0")
                .contact(new Contact().name("Jose JMG").email("contact@example.com")
                ...
                .servers(List.of(
                        ...
                        new Server().url("https://your-production-domain.com")
