...
public class GlobalExceptionHandler {
    ...
    public ResponseEntity<ApiErrorResponse> handlePostNotFound(PostNotFound ex,
            WebRequest request) {
    ...
    public ResponseEntity<ApiErrorResponse> handleValidationExceptions(
        ...
        ApiErrorResponse errorResponse = ApiErrorResponse.builder().timestamp(LocalDateTime.now())
                ...
                .path(request.getDescription(false)).details(errors).build();
    ...
    public ResponseEntity<ApiErrorResponse> handleAllExceptions(Exception ex, WebRequest request) {
        ...
        ApiErrorResponse errorResponse = ApiErrorResponse.builder().timestamp(LocalDateTime.now())
                ...
                .message("An unexpected error occurred").path(request.getDescription(false))
                .build();
